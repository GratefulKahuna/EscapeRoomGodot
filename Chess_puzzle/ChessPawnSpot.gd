		...
		if selected:
			...
			if current_item != Global.pawn:
				if current_slot and Global.isChessPiece(current_slot.current_item):
					...
					if prev_selected.current_item and Global.isChessPiece(prev_selected.current_item):
						if !current_item:
